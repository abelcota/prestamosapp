...
<body id="pages-sign-up" data-layout="empty-view-2">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 main">
                <form class="sign-up" method="post" action="" role="form">
                   <center><img src="img/logo_prestamosapp.png" alt="logo_prestamosapp" width=300>
                    ...
                    <p class="sign-up-link">I have an account <a href="login.php">Sign up here</a></p>
