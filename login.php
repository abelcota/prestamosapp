...
if (isset($_POST['login'])) {
    if ($_POST['email'] == '') {
        $msgBox = alertBox("Por favor ingrese su correo electrónico");
    } else
        if ($_POST['password'] == '') {  
            $msgBox = alertBox("Por favor ingrese su contraseña");
        } else {
            // Get User Info
            ...
            if ($stmt = $mysqli->prepare("SELECT UserId, FirstName, LastName, Email, Password, Currency from user WHERE Email = ? AND Password = ? ")) {
                ...
                if ($num_of_rows = $stmt->num_rows >= 1) {
                    ...
                    $msgBox = alertBox("El correo electrónico o la contraseña son incorrectos");
                }
            }
        }
...
<body id="pages-sign-in" data-layout="prestamosapp">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 main">
                <form method="post" action="" role="form" class="sign-in form-success">
    ...
    echo $msgBox;
            ...
            <input type="checkbox" value="remember-me">Recordarme
                    ...
                    <button class="btn btn-raised btn-lg btn-success btn-block" type="submit" name="login">Iniciar Sesión</button>
