...
?>        
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
				    <h2 class="page-header">Transacciones</h2><br>
                </div>
            </div>
            <div class="row">
                  <div class="col-lg-6 ">
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <i class="material-icons pull-left icon">file_upload</i> <span class="btn-title">Realizar Salida</span> 
                        </div>
                  ...
                  <div class="col-lg-6 ">
		            ...
		            <div class="panel panel-primary">
                        <div class="panel-heading">
                           <i class="material-icons pull-left icon">file_download</i> <span class="btn-title">Realizar Ingreso</span> 
                        </div>
                            <div class="panel-body">
